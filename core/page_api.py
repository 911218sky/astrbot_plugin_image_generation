...
class PluginPageApi:
    ...
    def _normalize_task(
        ...
        return {
            ...
            "batch_count": max(1, int(raw.get("batch_count") or 1)),
            "completed_count": max(0, int(raw.get("completed_count") or 0)),
            "success_count": max(0, int(raw.get("success_count") or 0)),
            "failed_count": max(0, int(raw.get("failed_count") or 0)),
            "provider_elapsed": self._as_float(raw.get("provider_elapsed")),
